...
class UVGDataSet(data.Dataset):
    def __init__(self, root="../../dataset/UVG/images/", filelist="../../dataset/UVG/originalv.txt", refdir='L12000', testfull=False):
...
class DataSet(data.Dataset):
    ...
    def get_vimeo(self, rootdir="../../dataset/vimeo_septuplet/sequences/", filefolderlist="../../dataset/vimeo_septuplet/test.txt"):
